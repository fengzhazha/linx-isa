#!/usr/bin/env python3
"""Generate canonical Sail decode/dispatch from the compiled v0.4 catalog."""
...
def prelude_lines(inst: dict, raw_fields: dict[str, tuple[str, int]], width: int) -> list[str]:
    ...
    elif mnemonic == "B.ATTR":
        lines.append("decoded_battr_raw_shadow = sail_zero_extend(inst, 64);")
...
def render(spec: dict, exec_text: str) -> str:
    ...
    lines = [
        "// Generated by tools/isa/gen_sail_decode.py from isa/v0.4/linxisa-v0.4.json.",
        "// Do not edit by hand.",
        "",
