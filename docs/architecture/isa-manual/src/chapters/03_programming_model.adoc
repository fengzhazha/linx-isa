...
* Canonical shader-kernel special operands are:
  - `lc0..lc2` / `lb0..lb2` for lane/group replay state,
...
* Each group has one scalar-uniform execution context; scalar instructions in the body execute once per group control-flow step.
