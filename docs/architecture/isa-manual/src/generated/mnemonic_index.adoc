...
This table lists unique mnemonics in the v0.56.4 catalog. Each mnemonic may have multiple encodable forms (different lengths, operand layouts, or suffix variants).
