...
This table lists unique mnemonics in the v0.56.2 catalog. Each mnemonic may have multiple encodable forms (different lengths, operand layouts, or suffix variants).
...
|`B.CATR` |Block Control Attribute |32 |1
|`B.DATR` |Block Data Attribute |32 |1
...
|`C.LDI` |Load Immediate Offset |16 |1
|`C.LWI` |Load Immediate Offset |16 |1
|`C.MOVI` |Move |16 |1
|`C.MOVR` |Move |16 |1
|`C.OR` |Arithmetic Operation |16 |1
|`C.SDI` |Store Immediate Offset |16 |1
...
|`C.SWI` |Store Immediate Offset |16 |1
