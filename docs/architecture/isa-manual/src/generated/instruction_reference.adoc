...
[[insnref-block-control-attribute]]
=== Block Control Attribute

[cols="1,1,2,4,6",options="header"]
|===
|Mnemonic |Len |Decode |Assembly |Notes
|`B.CATR` |32 |- |`B.CATR {trap, atomic, <aq, rl, aqrl>, far, dr}` |v0.56 split of legacy B.CATR/B.DATR control fields.
|===

[[insnref-block-data-attribute]]
=== Block Data Attribute

[cols="1,1,2,4,6",options="header"]
|===
|Mnemonic |Len |Decode |Assembly |Notes
|`B.DATR` |32 |- |`B.DATR {layout.{canon, normal}, datatype, padvalue, cmode, rmode, sat}` |v0.56 split of legacy B.CATR/B.DATR data fields. CMode is 3 bits; RMode is 3 bits; Sat is bit 31.
|===
...
|`B.IOT` |32 |- |`B.IOT SrcTile0<.reuse>, <last>, ->DstTile<Size>` |v0.56 one-input immediate-size tile descriptor; function=101 means only SrcTile0 is valid.
|`B.IOT` |32 |- |`B.IOT SrcTile0<.reuse>, SrcTile1<.reuse>, <last>, ->DstTile<Size>` |v0.56 two-input immediate-size tile descriptor. SrcTile0/1 are independent 6-bit fields; imm4 encodes 0B..512KB.
|`B.IOT` |32 |- |`B.IOT <last>, ->DstTile<Size>` |v0.56 no-input immediate-size tile descriptor; function=110 means only the destination allocation is valid.
|===
...
|`BSTART.PAR` |32 |- |`BSTART.PAR TileOpcode, DataType` |Legacy compatibility TEPL spelling; canonical v0.56 output uses BSTART.TEPL TileOpcode, DataType.
...
|`BSTART.TEPL` |32 |- |`BSTART.TEPL TileOpcode, DataType` |Tile opcode selects PTO template ops. Canonical v0.56 standardized assignments require TileOpcode[9:6]=0 and pack TileOpcode[5]=Mode with TileOpcode[4:0]=Function; unassigned values remain reserved for future template extension.
|`BSTART.TLOAD` |32 |- |`BSTART.TLOAD DataType` |Alias of BSTART.TMA Function=0. Requires B.ARG layout/pad and B.IOR stride/base plus B.IOT tile binding.
|`BSTART.TMA` |32 |- |`BSTART.TMA Function, DataType` |Generic TMA selector form. Function=0/1/2 are emitted as BSTART.TLOAD/BSTART.TSTORE/BSTART.TMOV aliases; 3..31 are reserved in v0.56 (architecturally illegal/UNPREDICTABLE): software must not generate them and implementations must not assign ad-hoc semantics.
|`BSTART.TMATMUL` |32 |- |`BSTART.TMATMUL DataType` |Alias of BSTART.CUBE Function=0. Requires B.DIM (LB0/LB1/LB2 as m,n,k) and tile bindings via B.IOT.
|`BSTART.TMATMUL.ACC` |32 |- |`BSTART.TMATMUL.ACC DataType` |Alias of BSTART.CUBE Function=2. Requires B.DIM (LB0/LB1/LB2 as m,n,k) and tile bindings via B.IOT.
...
|`BSTART.TSTORE` |32 |- |`BSTART.TSTORE DataType` |Alias of BSTART.TMA Function=1. Requires B.ARG layout/pad and B.IOR stride/base plus B.IOT tile binding.
...
|===
|Mnemonic |Len |Decode |Assembly |Notes
|`HL.PRF` |48 |- |`hl.prf{.l1,.l2,.l3} [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>]` |-
|`HL.PRF.A` |48 |- |`hl.prf.a{.l1,.l2,.l3} [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
...
|===
|Mnemonic |Len |Decode |Assembly |Notes
|`HL.SB.PO` |48 |- |`hl.sb.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
|`HL.SBI.PO` |48 |- |`hl.sbi.po SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SD.PO` |48 |- |`hl.sd.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<3], ->{t, u, Rd}` |-
|`HL.SD.UPO` |48 |- |`hl.sd.upo SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
|`HL.SDI.PO` |48 |- |`hl.sdi.po SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SDI.UPO` |48 |- |`hl.sdi.upo SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SH.PO` |48 |- |`hl.sh.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<1], ->{t, u, Rd}` |-
|`HL.SH.UPO` |48 |- |`hl.sh.upo SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
|`HL.SHI.PO` |48 |- |`hl.shi.po SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SHI.UPO` |48 |- |`hl.shi.upo SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SW.PO` |48 |- |`hl.sw.po SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<2], ->{t, u, Rd}` |-
|`HL.SW.UPO` |48 |- |`hl.sw.upo SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
...
|===
|Mnemonic |Len |Decode |Assembly |Notes
|`HL.SB.PR` |48 |- |`hl.sb.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
|`HL.SBI.PR` |48 |- |`hl.sbi.pr SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SD.PR` |48 |- |`hl.sd.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<3], ->{t, u, Rd}` |-
|`HL.SD.UPR` |48 |- |`hl.sd.upr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
|`HL.SDI.PR` |48 |- |`hl.sdi.pr SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SDI.UPR` |48 |- |`hl.sdi.upr SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SH.PR` |48 |- |`hl.sh.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<1], ->{t, u, Rd}` |-
|`HL.SH.UPR` |48 |- |`hl.sh.upr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
|`HL.SHI.PR` |48 |- |`hl.shi.pr SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SHI.UPR` |48 |- |`hl.shi.upr SrcD, [SrcR, simm], ->{t, u, Rd}` |-
|`HL.SW.PR` |48 |- |`hl.sw.pr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<2], ->{t, u, Rd}` |-
|`HL.SW.UPR` |48 |- |`hl.sw.upr SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>], ->{t, u, Rd}` |-
...
|`HL.SBP` |48 |- |`hl.sbp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
|`HL.SDIP` |48 |- |`hl.sdip SrcD, SrcD1, [SrcR, simm]` |-
|`HL.SDIP.U` |48 |- |`hl.sdip.u SrcD, SrcD1, [SrcR, simm]` |-
|`HL.SDP` |48 |- |`hl.sdp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}><<3]` |-
|`HL.SDP.U` |48 |- |`hl.sdp.u SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
|`HL.SHIP` |48 |- |`hl.ship SrcD, SrcD1, [SrcR, simm]` |-
|`HL.SHIP.U` |48 |- |`hl.ship.u SrcD, SrcD1, [SrcR, simm]` |-
|`HL.SHP` |48 |- |`hl.shp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}><<1]` |-
|`HL.SHP.U` |48 |- |`hl.shp.u SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
|`HL.SWIP` |48 |- |`hl.swip SrcD, SrcD1, [SrcR, simm]` |-
|`HL.SWIP.U` |48 |- |`hl.swip.u SrcD, SrcD1, [SrcR, simm]` |-
|`HL.SWP` |48 |- |`hl.swp SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}><<2]` |-
|`HL.SWP.U` |48 |- |`hl.swp.u SrcD, SrcD1, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
|===
...
|===
|Mnemonic |Len |Decode |Assembly |Notes
|`LB` |32 |- |`lb [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
|`LBU` |32 |- |`lbu [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
|`LD` |32 |- |`ld [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
|`LH` |32 |- |`lh [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
|`LHU` |32 |- |`lhu [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
|`LW` |32 |- |`lw [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
|`LWU` |32 |- |`lwu [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>], ->{t, u, Rd}` |-
|`PRF` |32 |- |`prf [SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>]` |-
...
|===
|Mnemonic |Len |Decode |Assembly |Notes
|`SB` |32 |- |`sb SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
|`SD` |32 |- |`sd SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<3]` |-
|`SD.U` |32 |- |`sd.u SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
|`SH` |32 |- |`sh SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<1]` |-
|`SH.U` |32 |- |`sh.u SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
|`SW` |32 |- |`sw SrcD, [SrcL, SrcR<{.sw,.uw,.neg}><<2]` |-
|`SW.U` |32 |- |`sw.u SrcD, [SrcL, SrcR<{.sw,.uw,.neg}>]` |-
