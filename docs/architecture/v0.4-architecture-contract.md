...
12. Contradictory legacy raw fragments are archived history only and are reserved or illegal in canonical v0.4.
13. Privileged state, trap envelopes, template replay flags, and body-fetch rules follow the v0.4 manual and state catalog.
