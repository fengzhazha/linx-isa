...
| ISA catalog parity (`v0.4`) | ✅ golden + current json | ✅ compile coverage tests | ✅ decode/execute gates | ✅ no stale active-surface refs | ✅ model-side contract checks | `python3 tools/isa/check_canonical_v04.py --root .` |
