...
cutover. It is not a live contract surface for canonical `v0.4`.
...
Those topics have now been promoted into the canonical `v0.4` manual, state
...
- Retired legacy pre-AVS contract artifacts are not part of current `v0.4`
  closure.
