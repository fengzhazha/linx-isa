...
<figure>
<img src="../wavedrom/enc_v_lw_or_parts.svg" alt="V.LW.OR encoding" width="100%" />
...
```c
// Execute V.LW.OR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.lw.or<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
