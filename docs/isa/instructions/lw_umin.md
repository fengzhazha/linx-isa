...
<figure>
<img src="../wavedrom/enc_lw_umin.svg" alt="LW.UMIN encoding" width="100%" />
...
```c
// Execute LW.UMIN as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lw.umin<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
