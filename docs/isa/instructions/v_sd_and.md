...
<figure>
<img src="../wavedrom/enc_v_sd_and_parts.svg" alt="V.SD.AND encoding" width="100%" />
...
```c
// Execute V.SD.AND as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sd.and<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
