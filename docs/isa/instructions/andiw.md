...
<figure>
<img src="../wavedrom/enc_andiw.svg" alt="ANDIW encoding" width="100%" />
...
32-bit word AND-immediate.

## Pseudocode (informative)

```c
// Execute ANDIW as defined by the Arithmetic Operation 32bit semantics.
```
