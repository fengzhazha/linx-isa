...
<figure>
<img src="../wavedrom/enc_hl_remu.svg" alt="HL.REMU encoding" width="100%" />
...
[48-bit HL.] Unsigned integer remainder.

## Pseudocode (informative)

```c
// Execute HL.REMU as defined by the Multi-Cycle ALU semantics.
```
...
|----------|--------|--------|
| `hl.remu SrcL, SrcR, ->Dst0, Dst1` | 48 | — |
