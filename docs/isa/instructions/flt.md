...
<figure>
<img src="../wavedrom/enc_flt.svg" alt="FLT encoding" width="100%" />
...
Floating-point less-than comparison (ordered).

## Pseudocode (informative)

```c
// Execute FLT as defined by the Floating-point Compare semantics.
```
