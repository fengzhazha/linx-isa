...
<figure>
<img src="../wavedrom/enc_hl_xoriw.svg" alt="HL.XORIW encoding" width="100%" />
...
```c
// Execute HL.XORIW as defined by the Arithmetic Operation 32bit semantics.
```
