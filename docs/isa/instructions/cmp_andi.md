...
<figure>
<img src="../wavedrom/enc_cmp_andi.svg" alt="CMP.ANDI encoding" width="100%" />
...
```c
// Execute CMP.ANDI as defined by the Compare Instruction semantics.
```
