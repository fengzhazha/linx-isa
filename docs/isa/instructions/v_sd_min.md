...
<figure>
<img src="../wavedrom/enc_v_sd_min_parts.svg" alt="V.SD.MIN encoding" width="100%" />
...
```c
// Execute V.SD.MIN as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sd.min<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
