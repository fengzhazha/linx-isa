...
<figure>
<img src="../wavedrom/enc_lw_and.svg" alt="LW.AND encoding" width="100%" />
...
```c
// Execute LW.AND as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lw.and<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
