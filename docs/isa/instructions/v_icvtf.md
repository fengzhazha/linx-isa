...
<figure>
<img src="../wavedrom/enc_v_icvtf_parts.svg" alt="V.ICVTF encoding" width="100%" />
...
```c
// Execute V.ICVTF as defined by the Format Convert semantics.
```
