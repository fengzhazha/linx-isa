...
<figure>
<img src="../wavedrom/enc_v_cmp_gei_parts.svg" alt="V.CMP.GEI encoding" width="100%" />
...
```c
// Execute V.CMP.GEI as defined by the Compare Instruction semantics.
```
