...
<figure>
<img src="../wavedrom/enc_v_fadd_parts.svg" alt="V.FADD encoding" width="100%" />
...
```c
// Execute V.FADD as defined by the Three-Source Floating Point semantics.
```
