...
<figure>
<img src="../wavedrom/enc_v_bxu_parts.svg" alt="V.BXU encoding" width="100%" />
...
[64-bit V.] Bit-field extract unsigned.

## Pseudocode (informative)

```c
// Execute V.BXU as defined by the Bit Manipulation semantics.
```
