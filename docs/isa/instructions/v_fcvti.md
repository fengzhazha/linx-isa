...
<figure>
<img src="../wavedrom/enc_v_fcvti_parts.svg" alt="V.FCVTI encoding" width="100%" />
...
```c
// Execute V.FCVTI as defined by the Format Convert semantics.
```
