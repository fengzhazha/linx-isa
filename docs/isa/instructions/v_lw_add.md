...
<figure>
<img src="../wavedrom/enc_v_lw_add_parts.svg" alt="V.LW.ADD encoding" width="100%" />
...
```c
// Execute V.LW.ADD as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.lw.add<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
