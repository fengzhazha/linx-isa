...
<figure>
<img src="../wavedrom/enc_v_lw_min_parts.svg" alt="V.LW.MIN encoding" width="100%" />
...
```c
// Execute V.LW.MIN as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.lw.min<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
