...
<figure>
<img src="../wavedrom/enc_ld_smax.svg" alt="LD.SMAX encoding" width="100%" />
...
```c
// Execute LD.SMAX as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `ld.smax<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
