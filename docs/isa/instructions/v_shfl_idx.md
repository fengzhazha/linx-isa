...
<figure>
<img src="../wavedrom/enc_v_shfl_idx_parts.svg" alt="V.SHFL.IDX encoding" width="100%" />
...
```c
// Execute V.SHFL.IDX as defined by the Shuffle semantics.
```
...
|----------|--------|--------|
| `v.shfl.idx SrcL, SrcR, SrcP, ->Dst` | 64 | — |
