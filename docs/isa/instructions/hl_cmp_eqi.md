...
<figure>
<img src="../wavedrom/enc_hl_cmp_eqi.svg" alt="HL.CMP.EQI encoding" width="100%" />
...
```c
// Execute HL.CMP.EQI as defined by the Compare Instruction semantics.
```
...
|----------|--------|--------|
| `hl.cmp.eqi SrcL, simm, ->{t, u, Rd}` | 48 | — |
