...
<figure>
<img src="../wavedrom/enc_remuw.svg" alt="REMUW encoding" width="100%" />
...
32-bit word unsigned remainder.

## Pseudocode (informative)

```c
// Execute REMUW as defined by the Multi-Cycle ALU semantics.
```
