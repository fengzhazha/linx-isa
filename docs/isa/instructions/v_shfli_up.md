...
<figure>
<img src="../wavedrom/enc_v_shfli_up_parts.svg" alt="V.SHFLI.UP encoding" width="100%" />
...
```c
// Execute V.SHFLI.UP as defined by the Shuffle semantics.
```
...
|----------|--------|--------|
| `v.shfli.up SrcL, SrcR, imm, ->Dst` | 64 | — |
