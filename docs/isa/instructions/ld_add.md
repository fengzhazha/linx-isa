...
<figure>
<img src="../wavedrom/enc_ld_add.svg" alt="LD.ADD encoding" width="100%" />
...
```c
// Execute LD.ADD as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `ld.add<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
