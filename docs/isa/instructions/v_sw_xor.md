...
<figure>
<img src="../wavedrom/enc_v_sw_xor_parts.svg" alt="V.SW.XOR encoding" width="100%" />
...
```c
// Execute V.SW.XOR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sw.xor<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
