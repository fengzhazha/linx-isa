...
<figure>
<img src="../wavedrom/enc_v_max_parts.svg" alt="V.MAX encoding" width="100%" />
...
```c
// Execute V.MAX as defined by the Two-Source Floating Point semantics.
```
