...
<figure>
<img src="../wavedrom/enc_v_lw_max_parts.svg" alt="V.LW.MAX encoding" width="100%" />
...
```c
// Execute V.LW.MAX as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.lw.max<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
