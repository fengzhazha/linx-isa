...
<figure>
<img src="../wavedrom/enc_lw_or.svg" alt="LW.OR encoding" width="100%" />
...
```c
// Execute LW.OR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lw.or<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
