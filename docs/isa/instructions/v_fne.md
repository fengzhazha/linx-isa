...
<figure>
<img src="../wavedrom/enc_v_fne_parts.svg" alt="V.FNE encoding" width="100%" />
...
```c
// Execute V.FNE as defined by the Two-Source Floating Point semantics.
```
