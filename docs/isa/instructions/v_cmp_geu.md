...
<figure>
<img src="../wavedrom/enc_v_cmp_geu_parts.svg" alt="V.CMP.GEU encoding" width="100%" />
...
```c
// Execute V.CMP.GEU as defined by the Compare Instruction semantics.
```
