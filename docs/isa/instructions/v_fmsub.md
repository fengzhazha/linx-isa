...
<figure>
<img src="../wavedrom/enc_v_fmsub_parts.svg" alt="V.FMSUB encoding" width="100%" />
...
```c
// Execute V.FMSUB as defined by the Three-Source Floating Point semantics.
```
