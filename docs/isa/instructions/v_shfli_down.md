...
<figure>
<img src="../wavedrom/enc_v_shfli_down_parts.svg" alt="V.SHFLI.DOWN encoding" width="100%" />
...
```c
// Execute V.SHFLI.DOWN as defined by the Shuffle semantics.
```
...
|----------|--------|--------|
| `v.shfli.down SrcL, SrcR, imm, ->Dst` | 64 | — |
