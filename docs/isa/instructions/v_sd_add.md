...
<figure>
<img src="../wavedrom/enc_v_sd_add_parts.svg" alt="V.SD.ADD encoding" width="100%" />
...
```c
// Execute V.SD.ADD as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sd.add<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
