...
<figure>
<img src="../wavedrom/enc_v_fnmsub_parts.svg" alt="V.FNMSUB encoding" width="100%" />
...
```c
// Execute V.FNMSUB as defined by the Three-Source Floating Point semantics.
```
...
|----------|--------|--------|
| `v.fnmsub SrcL, SrcR, SrcA, ->Dst` | 64 | — |
