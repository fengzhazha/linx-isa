...
<figure>
<img src="../wavedrom/enc_lr_h.svg" alt="LR.H encoding" width="100%" />
...
```c
// Execute LR.H as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lr.h<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], {->t, ->u, ->Rd}` | 32 | — |
