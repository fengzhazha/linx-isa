...
<figure>
<img src="../wavedrom/enc_v_ld_add_parts.svg" alt="V.LD.ADD encoding" width="100%" />
...
```c
// Execute V.LD.ADD as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.ld.add<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
