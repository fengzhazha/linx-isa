...
<figure>
<img src="../wavedrom/enc_v_cmp_lt_parts.svg" alt="V.CMP.LT encoding" width="100%" />
...
```c
// Execute V.CMP.LT as defined by the Compare Instruction semantics.
```
