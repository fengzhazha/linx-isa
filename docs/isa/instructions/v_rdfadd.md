...
<figure>
<img src="../wavedrom/enc_v_rdfadd_parts.svg" alt="V.RDFADD encoding" width="100%" />
...
```c
// Execute V.RDFADD as defined by the Reduce Operation with Register semantics.
```
