...
<figure>
<img src="../wavedrom/enc_v_sw_max_parts.svg" alt="V.SW.MAX encoding" width="100%" />
...
```c
// Execute V.SW.MAX as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sw.max<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
