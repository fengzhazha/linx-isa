...
<figure>
<img src="../wavedrom/enc_ld_umin.svg" alt="LD.UMIN encoding" width="100%" />
...
```c
// Execute LD.UMIN as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `ld.umin<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
