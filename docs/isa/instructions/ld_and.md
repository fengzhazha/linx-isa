...
<figure>
<img src="../wavedrom/enc_ld_and.svg" alt="LD.AND encoding" width="100%" />
...
```c
// Execute LD.AND as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `ld.and<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
