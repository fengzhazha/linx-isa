...
<figure>
<img src="../wavedrom/enc_v_fsub_parts.svg" alt="V.FSUB encoding" width="100%" />
...
```c
// Execute V.FSUB as defined by the Three-Source Floating Point semantics.
```
