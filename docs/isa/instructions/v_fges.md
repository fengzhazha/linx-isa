...
<figure>
<img src="../wavedrom/enc_v_fges_parts.svg" alt="V.FGES encoding" width="100%" />
...
```c
// Execute V.FGES as defined by the Two-Source Floating Point semantics.
```
