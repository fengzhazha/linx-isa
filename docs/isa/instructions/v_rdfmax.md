...
<figure>
<img src="../wavedrom/enc_v_rdfmax_parts.svg" alt="V.RDFMAX encoding" width="100%" />
...
```c
// Execute V.RDFMAX as defined by the Reduce Operation with Register semantics.
```
