...
<figure>
<img src="../wavedrom/enc_srliw.svg" alt="SRLIW encoding" width="100%" />
...
32-bit word logical right shift (immediate).

## Pseudocode (informative)

```c
// Execute SRLIW as defined by the Arithmetic Operation 32bit semantics.
```
