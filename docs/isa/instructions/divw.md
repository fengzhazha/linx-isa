...
<figure>
<img src="../wavedrom/enc_divw.svg" alt="DIVW encoding" width="100%" />
...
32-bit word signed integer division.

## Pseudocode (informative)

```c
// Execute DIVW as defined by the Multi-Cycle ALU semantics.
```
