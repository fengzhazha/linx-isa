...
<figure>
<img src="../wavedrom/enc_v_fmadd_parts.svg" alt="V.FMADD encoding" width="100%" />
...
```c
// Execute V.FMADD as defined by the Three-Source Floating Point semantics.
```
