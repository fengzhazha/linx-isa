...
<figure>
<img src="../wavedrom/enc_c_b_dim.svg" alt="C.B.DIM encoding" width="100%" />
...
```c
// Execute C.B.DIM as defined by the Block Dimension semantics.
```
