...
<figure>
<img src="../wavedrom/enc_cmp_nei.svg" alt="CMP.NEI encoding" width="100%" />
...
```c
// Execute CMP.NEI as defined by the Compare Instruction semantics.
```
