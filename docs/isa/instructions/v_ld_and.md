...
<figure>
<img src="../wavedrom/enc_v_ld_and_parts.svg" alt="V.LD.AND encoding" width="100%" />
...
```c
// Execute V.LD.AND as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.ld.and<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
