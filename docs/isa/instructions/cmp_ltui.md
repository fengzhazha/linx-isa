...
<figure>
<img src="../wavedrom/enc_cmp_ltui.svg" alt="CMP.LTUI encoding" width="100%" />
...
```c
// Execute CMP.LTUI as defined by the Compare Instruction semantics.
```
