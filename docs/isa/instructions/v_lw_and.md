...
<figure>
<img src="../wavedrom/enc_v_lw_and_parts.svg" alt="V.LW.AND encoding" width="100%" />
...
```c
// Execute V.LW.AND as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.lw.and<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
