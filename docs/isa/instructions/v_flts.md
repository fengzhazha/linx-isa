...
<figure>
<img src="../wavedrom/enc_v_flts_parts.svg" alt="V.FLTS encoding" width="100%" />
...
```c
// Execute V.FLTS as defined by the Two-Source Floating Point semantics.
```
