...
<figure>
<img src="../wavedrom/enc_ld_or.svg" alt="LD.OR encoding" width="100%" />
...
```c
// Execute LD.OR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `ld.or<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
