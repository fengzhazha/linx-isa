...
<figure>
<img src="../wavedrom/enc_v_cmp_ltu_parts.svg" alt="V.CMP.LTU encoding" width="100%" />
...
```c
// Execute V.CMP.LTU as defined by the Compare Instruction semantics.
```
