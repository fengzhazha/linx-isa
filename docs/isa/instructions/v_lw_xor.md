...
<figure>
<img src="../wavedrom/enc_v_lw_xor_parts.svg" alt="V.LW.XOR encoding" width="100%" />
...
```c
// Execute V.LW.XOR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.lw.xor<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
