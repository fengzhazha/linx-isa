...
<figure>
<img src="../wavedrom/enc_v_lw_parts.svg" alt="V.LW encoding" width="100%" />
...
[64-bit V.] Loads a signed 32-bit value from memory.
...
|----------|--------|--------|
| `v.lw<.local> [SrcL, <lc0<<2>, SrcR<<<shamt>], ->Dst` | 64 | — |
