...
<figure>
<img src="../wavedrom/enc_swaph.svg" alt="SWAPH encoding" width="100%" />
...
```c
// Execute SWAPH as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `swaph<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
