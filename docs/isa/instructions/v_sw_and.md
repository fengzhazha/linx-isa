...
<figure>
<img src="../wavedrom/enc_v_sw_and_parts.svg" alt="V.SW.AND encoding" width="100%" />
...
```c
// Execute V.SW.AND as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sw.and<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
