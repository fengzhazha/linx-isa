...
<figure>
<img src="../wavedrom/enc_lr_w.svg" alt="LR.W encoding" width="100%" />
...
```c
// Execute LR.W as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lr.w<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], {->t, ->u, ->Rd}` | 32 | — |
