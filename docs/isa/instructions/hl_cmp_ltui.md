...
<figure>
<img src="../wavedrom/enc_hl_cmp_ltui.svg" alt="HL.CMP.LTUI encoding" width="100%" />
...
```c
// Execute HL.CMP.LTUI as defined by the Compare Instruction semantics.
```
...
|----------|--------|--------|
| `hl.cmp.ltui SrcL, uimm, ->{t, u, Rd}` | 48 | — |
