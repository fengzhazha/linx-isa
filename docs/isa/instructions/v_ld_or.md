...
<figure>
<img src="../wavedrom/enc_v_ld_or_parts.svg" alt="V.LD.OR encoding" width="100%" />
...
```c
// Execute V.LD.OR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.ld.or<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
