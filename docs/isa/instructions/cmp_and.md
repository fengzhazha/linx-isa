...
<figure>
<img src="../wavedrom/enc_cmp_and.svg" alt="CMP.AND encoding" width="100%" />
...
```c
// Execute CMP.AND as defined by the Compare Instruction semantics.
```
...
|----------|--------|--------|
| `cmp.and SrcL, SrcR<.sw, .uw, .not>, ->{t, u, Rd}` | 32 | — |
