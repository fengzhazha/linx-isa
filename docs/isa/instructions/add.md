...
<figure>
<img src="../wavedrom/enc_add.svg" alt="ADD encoding" width="100%" />
...
Integer addition. Writes the sum of two registers to the destination.
...
|----------|--------|--------|
| `add SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>, ->{t, u, Rd}` | 32 | — |
