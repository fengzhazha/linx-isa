...
<figure>
<img src="../wavedrom/enc_v_cmp_ltui_parts.svg" alt="V.CMP.LTUI encoding" width="100%" />
...
```c
// Execute V.CMP.LTUI as defined by the Compare Instruction semantics.
```
