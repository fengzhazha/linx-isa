...
<figure>
<img src="../wavedrom/enc_v_sd_or_parts.svg" alt="V.SD.OR encoding" width="100%" />
...
```c
// Execute V.SD.OR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sd.or<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
