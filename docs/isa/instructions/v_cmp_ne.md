...
<figure>
<img src="../wavedrom/enc_v_cmp_ne_parts.svg" alt="V.CMP.NE encoding" width="100%" />
...
```c
// Execute V.CMP.NE as defined by the Compare Instruction semantics.
```
