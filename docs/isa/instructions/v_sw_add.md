...
<figure>
<img src="../wavedrom/enc_v_sw_add_parts.svg" alt="V.SW.ADD encoding" width="100%" />
...
```c
// Execute V.SW.ADD as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sw.add<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
