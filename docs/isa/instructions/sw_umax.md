...
<figure>
<img src="../wavedrom/enc_sw_umax.svg" alt="SW.UMAX encoding" width="100%" />
...
```c
// Execute SW.UMAX as defined by the Atomic Operation semantics.
```
