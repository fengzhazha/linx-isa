...
<figure>
<img src="../wavedrom/enc_v_fmul_parts.svg" alt="V.FMUL encoding" width="100%" />
...
```c
// Execute V.FMUL as defined by the Three-Source Floating Point semantics.
```
