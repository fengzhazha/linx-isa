...
<figure>
<img src="../wavedrom/enc_v_cmp_lti_parts.svg" alt="V.CMP.LTI encoding" width="100%" />
...
```c
// Execute V.CMP.LTI as defined by the Compare Instruction semantics.
```
