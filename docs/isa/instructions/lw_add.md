...
<figure>
<img src="../wavedrom/enc_lw_add.svg" alt="LW.ADD encoding" width="100%" />
...
```c
// Execute LW.ADD as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lw.add<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
