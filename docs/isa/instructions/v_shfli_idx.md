...
<figure>
<img src="../wavedrom/enc_v_shfli_idx_parts.svg" alt="V.SHFLI.IDX encoding" width="100%" />
...
```c
// Execute V.SHFLI.IDX as defined by the Shuffle semantics.
```
...
|----------|--------|--------|
| `v.shfli.idx SrcL, SrcR, imm, ->Dst` | 64 | — |
