...
<figure>
<img src="../wavedrom/enc_lw_smax.svg" alt="LW.SMAX encoding" width="100%" />
...
```c
// Execute LW.SMAX as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lw.smax<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
