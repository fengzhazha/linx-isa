...
<figure>
<img src="../wavedrom/enc_v_shfl_down_parts.svg" alt="V.SHFL.DOWN encoding" width="100%" />
...
```c
// Execute V.SHFL.DOWN as defined by the Shuffle semantics.
```
...
|----------|--------|--------|
| `v.shfl.down SrcL, SrcR, SrcP, ->Dst` | 64 | — |
