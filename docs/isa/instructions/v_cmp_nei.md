...
<figure>
<img src="../wavedrom/enc_v_cmp_nei_parts.svg" alt="V.CMP.NEI encoding" width="100%" />
...
```c
// Execute V.CMP.NEI as defined by the Compare Instruction semantics.
```
