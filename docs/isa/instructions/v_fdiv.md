...
<figure>
<img src="../wavedrom/enc_v_fdiv_parts.svg" alt="V.FDIV encoding" width="100%" />
...
```c
// Execute V.FDIV as defined by the Three-Source Floating Point semantics.
```
