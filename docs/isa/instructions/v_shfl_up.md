...
<figure>
<img src="../wavedrom/enc_v_shfl_up_parts.svg" alt="V.SHFL.UP encoding" width="100%" />
...
```c
// Execute V.SHFL.UP as defined by the Shuffle semantics.
```
...
|----------|--------|--------|
| `v.shfl.up SrcL, SrcR, SrcP, ->Dst` | 64 | — |
