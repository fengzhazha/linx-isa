...
<figure>
<img src="../wavedrom/enc_v_cmp_andi_parts.svg" alt="V.CMP.ANDI encoding" width="100%" />
...
```c
// Execute V.CMP.ANDI as defined by the Compare Instruction semantics.
```
