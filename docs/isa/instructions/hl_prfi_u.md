...
<figure>
<img src="../wavedrom/enc_hl_prfi_u.svg" alt="HL.PRFI.U encoding" width="100%" />
...
```c
// Execute HL.PRFI.U as defined by the Prefetch semantics.
```
...
|----------|--------|--------|
| `hl.prfi.u{.l1,.l2,.l3} [SrcL, simm]` | 48 | — |
