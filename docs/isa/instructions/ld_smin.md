...
<figure>
<img src="../wavedrom/enc_ld_smin.svg" alt="LD.SMIN encoding" width="100%" />
...
```c
// Execute LD.SMIN as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `ld.smin<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
