...
<figure>
<img src="../wavedrom/enc_ld_xor.svg" alt="LD.XOR encoding" width="100%" />
...
```c
// Execute LD.XOR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `ld.xor<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
