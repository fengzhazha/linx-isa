...
<figure>
<img src="../wavedrom/enc_cmp_ltu.svg" alt="CMP.LTU encoding" width="100%" />
...
```c
// Execute CMP.LTU as defined by the Compare Instruction semantics.
```
...
|----------|--------|--------|
| `cmp.ltu SrcL, SrcR<{.sw, .uw}>, ->{t, u, Rd}` | 32 | — |
