...
<figure>
<img src="../wavedrom/enc_v_sw_min_parts.svg" alt="V.SW.MIN encoding" width="100%" />
...
```c
// Execute V.SW.MIN as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sw.min<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
