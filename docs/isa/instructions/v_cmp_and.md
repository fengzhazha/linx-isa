...
<figure>
<img src="../wavedrom/enc_v_cmp_and_parts.svg" alt="V.CMP.AND encoding" width="100%" />
...
```c
// Execute V.CMP.AND as defined by the Compare Instruction semantics.
```
