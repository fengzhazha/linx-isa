...
<figure>
<img src="../wavedrom/enc_v_flt_parts.svg" alt="V.FLT encoding" width="100%" />
...
```c
// Execute V.FLT as defined by the Two-Source Floating Point semantics.
```
