...
<figure>
<img src="../wavedrom/enc_b_eq.svg" alt="B.EQ encoding" width="100%" />
...
Conditional branch taken when SrcL equals SrcR.

## Pseudocode (informative)

```c
// Execute B.EQ as defined by the Branch semantics.
```
