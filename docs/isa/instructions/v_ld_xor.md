...
<figure>
<img src="../wavedrom/enc_v_ld_xor_parts.svg" alt="V.LD.XOR encoding" width="100%" />
...
```c
// Execute V.LD.XOR as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.ld.xor<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, ->Dst` | 64 | — |
