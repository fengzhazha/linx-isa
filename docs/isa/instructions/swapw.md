...
<figure>
<img src="../wavedrom/enc_swapw.svg" alt="SWAPW encoding" width="100%" />
...
```c
// Execute SWAPW as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `swapw<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
