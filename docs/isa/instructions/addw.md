...
<figure>
<img src="../wavedrom/enc_addw.svg" alt="ADDW encoding" width="100%" />
...
32-bit word integer addition.

## Pseudocode (informative)

```c
// Execute ADDW as defined by the Arithmetic Operation 32bit semantics.
```
...
|----------|--------|--------|
| `addw SrcL, SrcR<{.sw,.uw,.neg}><<<shamt>, ->{t, u, Rd}` | 32 | — |
