...
<figure>
<img src="../wavedrom/enc_v_frecip_parts.svg" alt="V.FRECIP encoding" width="100%" />
...
```c
// Execute V.FRECIP as defined by the Floating Point Arithmetic semantics.
```
