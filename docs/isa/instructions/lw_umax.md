...
<figure>
<img src="../wavedrom/enc_lw_umax.svg" alt="LW.UMAX encoding" width="100%" />
...
```c
// Execute LW.UMAX as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `lw.umax<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
