...
<figure>
<img src="../wavedrom/enc_hl_bstart_std.svg" alt="HL.BSTART.STD encoding" width="100%" />
...
|----------|--------|--------|
| `HL.BSTART.STD CALL, <label>` | 48 | — |
| `HL.BSTART.STD FALL<, fixup_label>` | 48 | — |
| `HL.BSTART.STD COND, <label>` | 48 | — |
| `HL.BSTART.STD DIRECT, <label>` | 48 | — |
