...
<figure>
<img src="../wavedrom/enc_sc_h.svg" alt="SC.H encoding" width="100%" />
...
```c
// Execute SC.H as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `sc.h<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> SrcL, [SrcR], {->t, ->u, ->Rd}` | 32 | — |
