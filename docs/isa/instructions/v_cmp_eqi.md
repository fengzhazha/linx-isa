...
<figure>
<img src="../wavedrom/enc_v_cmp_eqi_parts.svg" alt="V.CMP.EQI encoding" width="100%" />
...
```c
// Execute V.CMP.EQI as defined by the Compare Instruction semantics.
```
