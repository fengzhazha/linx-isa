...
<figure>
<img src="../wavedrom/enc_v_cmp_eq_parts.svg" alt="V.CMP.EQ encoding" width="100%" />
...
```c
// Execute V.CMP.EQ as defined by the Compare Instruction semantics.
```
