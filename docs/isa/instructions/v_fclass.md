...
<figure>
<img src="../wavedrom/enc_v_fclass_parts.svg" alt="V.FCLASS encoding" width="100%" />
...
```c
// Execute V.FCLASS as defined by the Floating Point Arithmetic semantics.
```
