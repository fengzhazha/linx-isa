...
<figure>
<img src="../wavedrom/enc_sd_umax.svg" alt="SD.UMAX encoding" width="100%" />
...
```c
// Execute SD.UMAX as defined by the Atomic Operation semantics.
```
