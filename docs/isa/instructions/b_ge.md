...
<figure>
<img src="../wavedrom/enc_b_ge.svg" alt="B.GE encoding" width="100%" />
...
Conditional branch taken when SrcL is greater than or equal to SrcR (signed).

## Pseudocode (informative)

```c
// Execute B.GE as defined by the Branch semantics.
```
