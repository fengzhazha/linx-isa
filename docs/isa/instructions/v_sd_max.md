...
<figure>
<img src="../wavedrom/enc_v_sd_max_parts.svg" alt="V.SD.MAX encoding" width="100%" />
...
```c
// Execute V.SD.MAX as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `v.sd.max<.{rl, f, rd, rlf, rdf, rlrd, rlrdf}> [SrcL], SrcR` | 64 | — |
