...
<figure>
<img src="../wavedrom/enc_v_shfl_bfly_parts.svg" alt="V.SHFL.BFLY encoding" width="100%" />
...
```c
// Execute V.SHFL.BFLY as defined by the Shuffle semantics.
```
