...
<figure>
<img src="../wavedrom/enc_v_fge_parts.svg" alt="V.FGE encoding" width="100%" />
...
```c
// Execute V.FGE as defined by the Two-Source Floating Point semantics.
```
