...
<figure>
<img src="../wavedrom/enc_swapd.svg" alt="SWAPD encoding" width="100%" />
...
```c
// Execute SWAPD as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `swapd<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> [SrcL], SrcR, {->t, ->u, ->Rd}` | 32 | — |
