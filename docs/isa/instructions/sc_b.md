...
<figure>
<img src="../wavedrom/enc_sc_b.svg" alt="SC.B encoding" width="100%" />
...
```c
// Execute SC.B as defined by the Atomic Operation semantics.
```
...
|----------|--------|--------|
| `sc.b<.{aq, rl, f, aqrl, aqf, rlf, aqrlf}> SrcL, [SrcR], {->t, ->u, ->Rd}` | 32 | — |
