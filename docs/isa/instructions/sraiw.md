...
<figure>
<img src="../wavedrom/enc_sraiw.svg" alt="SRAIW encoding" width="100%" />
...
32-bit word arithmetic right shift (immediate).

## Pseudocode (informative)

```c
// Execute SRAIW as defined by the Arithmetic Operation 32bit semantics.
```
