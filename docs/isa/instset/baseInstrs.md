...
| **branch parameter Settings** | [SETC.EQ](../inst/misa_g/SETC.EQ.md), [SETC.NE](../inst/misa_g/SETC.NE.md), [SETC.AND](../inst/misa_g/SETC.AND.md), [SETC.OR](../inst/misa_g/SETC.OR.md), [SETC.LT](../inst/misa_g/SETC.LT.md), [SETC.GE](../inst/misa_g/SETC.GE.md), [SETC.LTU](../inst/misa_g/SETC.LTU.md), [SETC.GEU](../inst/misa_g/SETC.GEU.md) |
| **With immediate data·branch parameter settings** | [SETC.EQI](../inst/misa_g/SETC.EQI.md), [SETC.NEI](../inst/misa_g/SETC.NEI.md), [SETC.ANDI](../inst/misa_g/SETC.ANDI.md), [SETC.ORI](../inst/misa_g/SETC.ORI.md), [SETC.LTI](../inst/misa_g/SETC.LTI.md), [SETC.GEI](../inst/misa_g/SETC.GEI.md), [SETC.LTUI](../inst/misa_g/SETC.LTUI.md), [SETC.GEUI](../inst/misa_g/SETC.GEUI.md) |
...
| **Memory Storage·Register Offset** | [SB](../inst/misa_g/SB.md), [SH](../inst/misa_g/SH.md), [SW](../inst/misa_g/SW.md), [SD](../inst/misa_g/SD.md), [SH.U](../inst/misa_g/SH.U.md), [SW.U](../inst/misa_g/SW.U.md), [SD.U](../inst/misa_g/SD.U.md) |
| **Memory storage·immediate offset** | [SBI](../inst/misa_g/SBI.md), [SHI](../inst/misa_g/SHI.md), [SWI](../inst/misa_g/SWI.md), [SDI](../inst/misa_g/SDI.md), [SHI.U](../inst/misa_g/SHI.U.md), [SWI.U](../inst/misa_g/SWI.U.md), [SDI.U](../inst/misa_g/SDI.U.md) |
