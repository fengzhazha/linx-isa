# LinxISA Assembly Sample Pack (v0.56)

Canonical public assembly examples for LinxISA v0.56.
...
Source: `docs/reference/examples/v0.56/curated/linxisa-v0.56-normalized.asm`
